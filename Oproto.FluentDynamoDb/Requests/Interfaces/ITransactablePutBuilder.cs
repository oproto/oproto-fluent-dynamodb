...
{
    /// <summary>
    /// Gets the table name for the put operation.
    /// </summary>
    /// <returns>The DynamoDB table name.</returns>
    internal string GetTableName();

    /// <summary>
    /// Gets the item to be put into the table.
    /// </summary>
    /// <returns>Dictionary of attribute names to attribute values representing the item.</returns>
    internal Dictionary<string, AttributeValue> GetItem();

    /// <summary>
    /// Gets the condition expression for the put operation, if specified.
    /// </summary>
    /// <returns>The condition expression string, or null if not specified.</returns>
    internal string? GetConditionExpression();

    /// <summary>
    /// Gets the expression attribute name mappings for the put operation.
    /// </summary>
    ...
    /// <summary>
    /// Gets the expression attribute value mappings for the put operation.
    /// </summary>
