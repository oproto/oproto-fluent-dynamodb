...
/// Provides internal methods to extract request data for transaction composition.
/// </summary>
public interface ITransactableConditionCheckBuilder
{
    /// <summary>
    /// Gets the table name for the condition check operation.
    /// </summary>
    /// <returns>The DynamoDB table name.</returns>
    internal string GetTableName();

    /// <summary>
    /// Gets the key identifying the item to check.
    /// </summary>
    /// <returns>Dictionary of key attribute names to attribute values.</returns>
    internal Dictionary<string, AttributeValue> GetKey();

    /// <summary>
    /// Gets the condition expression for the condition check operation.
    /// </summary>
    /// <returns>The condition expression string.</returns>
    internal string GetConditionExpression();

    /// <summary>
    /// Gets the expression attribute name mappings for the condition check operation.
    /// </summary>
    ...
    /// <summary>
    /// Gets the expression attribute value mappings for the condition check operation.
    /// </summary>
